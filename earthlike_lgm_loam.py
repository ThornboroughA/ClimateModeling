...
model = exo.Model(workdir='loam_lgm_27',  #names the folder where files will be kept while the model runs
                  modelname='loam_lgm_27',    #sets the name for various other files and folders
                  outputtype='.nc',     #sets the filetype for the output; '.nc' is a netcdf file
                  resolution='T42',     #sets the model resolution, 'T21' is 32x64, 'T42' is 64x128, and 'T63' is 96x192
...
model.configure(timestep=45,                                #length of model timestep in minutes
                ...
                eccentricity=0.018994,                      #orbital eccentricity
                fixedorbit=True,                            #prevents orbit from changing over time
                rotationperiod=1,                           #sidereal day length compared to Earth
                obliquity=22.949,                           #obliquity of planet rotation, a.k.a. axial tilt, in degrees
                lonvernaleq=102.7, #verify! GPT says 294.42 is correct                         #angle along orbit from northern fall equinox to periapsis in degrees
                ...
                landmap="SRA/hm_lgm_t42_7700_surf_0172.sra",
                topomap="SRA/hm_lgm_t42_7700_surf_0129.sra",
                ...
                pCO2=180e-6,                                #partial pressure of atmospheric carbon dioxide in bar
                ...
                glaciers={'toggle': True,                   #toggles glacier module
                          'mindepth': 1,                    #depth of snow requires to form glacier
